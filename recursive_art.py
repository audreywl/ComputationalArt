...
def build_random_function(min_depth, max_depth):
	...
	functions = [lambda x,y: next_function_1(x,y)*next_function_2(x,y), 
	lambda x,y: .5*next_function_1(x,y)*next_function_2(x,y), 
	lambda x,y: math.cos(2* math.pi * next_function_1(x,y)), 
	lambda x,y: math.sin(2* math.pi * next_function_1(x,y)),
	lambda x,y: next_function_1(x,y)*next_function_1(x,y), 
	lambda x,y: math.sqrt(abs(next_function_1(x,y)))]
